...
const JOBS = [
  ...
  { id: 101, airline: "Emirates", role: "Captain", aircraft: "B777 / A380", region: "Middle East", location: "Dubai (DXB)", type: "Direct Entry", minHours: 7000, rated: true, posted: 0, verified: true,
  ...
  { id: 102, airline: "Emirates", role: "Captain", aircraft: "Accelerated Command", region: "Middle East", location: "Dubai (DXB)", type: "Direct Entry", minHours: 5000, rated: false, posted: 0, verified: true,
    salary: "Tax-free + housing + profit share",
  ...
  { id: 103, airline: "Emirates", role: "First Officer", aircraft: "B777 / A380", region: "Middle East", location: "Dubai (DXB)", type: "Direct Entry", minHours: 2000, rated: false, posted: 0, verified: true,
    salary: "Tax-free + housing + profit share",
  ...
  { id: 104, airline: "Emirates", role: "Cadet Pilot", aircraft: "National Cadet Programme", region: "Middle East", location: "Dubai (DXB)", type: "Cadet", minHours: 0, rated: false, posted: 0, verified: true,
  ...
  { id: 111, airline: "Etihad Airways", role: "First Officer", aircraft: "A320 (non-rated)", region: "Middle East", location: "Abu Dhabi (AUH)", type: "Direct Entry", minHours: 2500, rated: false, posted: 0, verified: true,
  ...
  { id: 112, airline: "Etihad Airways", role: "First Officer", aircraft: "A320", region: "Middle East", location: "Abu Dhabi (AUH)", type: "Rated", minHours: 1500, rated: true, posted: 0, verified: true,
    salary: "Tax-free, up to $138,318/yr",
  ...
  { id: 113, airline: "Etihad Airways", role: "First Officer", aircraft: "Airbus Widebody", region: "Middle East", location: "Abu Dhabi (AUH)", type: "Rated", minHours: 2500, rated: true, posted: 0, verified: true,
    salary: "Tax-free, up to $138,318/yr",
  ...
  { id: 114, airline: "Etihad Airways", role: "Captain", aircraft: "A320 (non-rated)", region: "Middle East", location: "Abu Dhabi (AUH)", type: "Direct Entry", minHours: 7000, rated: false, posted: 0, verified: true,
  ...
  { id: 115, airline: "Etihad Airways", role: "Captain", aircraft: "A320", region: "Middle East", location: "Abu Dhabi (AUH)", type: "Rated", minHours: 5500, rated: true, posted: 0, verified: true,
    salary: "Tax-free, up to $181,589/yr",
  ...
  { id: 116, airline: "Etihad Airways", role: "Captain", aircraft: "Airbus Widebody", region: "Middle East", location: "Abu Dhabi (AUH)", type: "Rated", minHours: 7000, rated: true, posted: 0, verified: true,
    salary: "Tax-free, up to $181,589/yr",
  ...
  { id: 117, airline: "Etihad Airways", role: "Captain", aircraft: "A320 — Instructor (TRI)", region: "Middle East", location: "Abu Dhabi (AUH)", type: "Rated", minHours: 5500, rated: true, posted: 0, verified: true,
  ...
  { id: 121, airline: "Qatar Airways", role: "Cadet Pilot", aircraft: "MPL Cadet Programme", region: "Middle East", location: "Doha (DOH)", type: "Cadet", minHours: 0, rated: false, posted: 0, verified: true,
    salary: "See official listing",
  ...
  { id: 131, airline: "flydubai", role: "Captain", aircraft: "B737 NG / MAX", region: "Middle East", location: "Dubai (DXB)", type: "Rated", minHours: 5000, rated: true, posted: 0, verified: true,
  ...
  { id: 132, airline: "flydubai", role: "First Officer", aircraft: "B737 NG / MAX", region: "Middle East", location: "Dubai (DXB)", type: "Direct Entry", minHours: 1500, rated: false, posted: 0, verified: true,
  ...
  { id: 133, airline: "flydubai", role: "Cadet Pilot", aircraft: "Ab Initio Programme", region: "Middle East", location: "Dubai (DXB)", type: "Cadet", minHours: 0, rated: false, posted: 0, verified: true,
    salary: "See official listing",
  ...
  { id: 141, airline: "Ryanair", role: "Captain", aircraft: "B737-800 / 8200", region: "Europe", location: "Bases across Europe", type: "Rated", minHours: 3000, rated: true, posted: 0, verified: true,
  ...
  { id: 142, airline: "Ryanair", role: "First Officer", aircraft: "B737 (licensed cadets)", region: "Europe", location: "Bases across Europe", type: "Rated", minHours: 200, rated: false, posted: 0, verified: true,
    salary: "See official listing",
    reqs: "CPL/fATPL holders — type rating programme, fastest route to command.",
    applyUrl: "https://careers.ryanair.com/pilots/cadets/" },
  { id: 143, airline: "Ryanair", role: "Cadet Pilot", aircraft: "Future Flyer Academy", region: "Europe", location: "EU training partners", type: "Cadet", minHours: 0, rated: false, posted: 0, verified: true,
  ...
  { id: 151, airline: "easyJet", role: "Captain", aircraft: "A320 family", region: "Europe", location: "UK & EU bases", type: "Direct Entry", minHours: 4000, rated: false, posted: 0, verified: true,
  ...
  { id: 152, airline: "easyJet", role: "First Officer", aircraft: "A320 family", region: "Europe", location: "UK & EU bases", type: "Direct Entry", minHours: 500, rated: false, posted: 0, verified: true,
  ...
  { id: 161, airline: "Wizz Air", role: "Captain", aircraft: "A320 / A321", region: "Europe", location: "35+ bases EU & ME", type: "Rated", minHours: 3000, rated: true, posted: 0, verified: true,
  ...
  { id: 162, airline: "Wizz Air", role: "First Officer", aircraft: "A320 / A321", region: "Europe", location: "35+ bases EU & ME", type: "Direct Entry", minHours: 500, rated: false, posted: 0, verified: true,
    salary: "Local contracts — see portal",
    reqs: "Rated: current A320 rating + 500 hrs on type. Non-rated: 1,500 hrs on jet MPA >50t.",
    applyUrl: "https://careers.wizzair.com/go/Pilot-Jobs/5258601" },
  { id: 163, airline: "Wizz Air", role: "Cadet Pilot", aircraft: "Pilot Academy (WAPA)", region: "Europe", location: "Budapest + partners", type: "Cadet", minHours: 0, rated: false, posted: 0, verified: true,
  ...
  { id: 221, airline: "Vueling", role: "First Officer", aircraft: "A320", region: "Europe", location: "Barcelona + Spanish bases", type: "Direct Entry", minHours: 200, rated: false, posted: 0, verified: true,
    salary: "See official listing",
  ...
  { id: 222, airline: "Vueling", role: "Cadet Pilot", aircraft: "CAE Cadet Programme", region: "Europe", location: "CAE academies + Barcelona", type: "Cadet", minHours: 0, rated: false, posted: 0, verified: true,
  ...
  { id: 223, airline: "Jet2", role: "Captain", aircraft: "B737 / A321neo", region: "Europe", location: "UK bases", type: "Direct Entry", minHours: 3000, rated: false, posted: 0, verified: true,
  ...
  { id: 224, airline: "Jet2", role: "First Officer", aircraft: "B737 / A321neo", region: "Europe", location: "UK bases", type: "Rated", minHours: 500, rated: true, posted: 0, verified: true,
    salary: "See official listing",
  ...
  { id: 225, airline: "Norwegian", role: "First Officer", aircraft: "B737", region: "Europe", location: "Oslo Gardermoen (OSL)", type: "Rated", minHours: 500, rated: true, posted: 0, verified: true,
    salary: "See official listing",
  ...
  { id: 226, airline: "Norwegian", role: "First Officer", aircraft: "B737 (non-rated)", region: "Europe", location: "Oslo Gardermoen (OSL)", type: "Direct Entry", minHours: 1500, rated: false, posted: 0, verified: true,
    salary: "See official listing",
  ...
  /* ---- IndiGo (goindigo.in) ---- */
  { id: 227, airline: "IndiGo", role: "Captain", aircraft: "A320", region: "Asia-Pacific", location: "Indian bases", type: "Rated", minHours: 3000, rated: true, posted: 0, verified: true,
  ...
  { id: 228, airline: "IndiGo", role: "First Officer", aircraft: "A320", region: "Asia-Pacific", location: "Indian bases", type: "Rated", minHours: 500, rated: true, posted: 0, verified: true,
    salary: "₹1.8–3.5 lakh/mo (typical)",
    reqs: "Line-released A320 FOs · 200+ hrs post line release · valid FRTO/RTR, Class 1 · under 55.",
    applyUrl: "https://www.goindigo.in/careers/departments/flightoperations.html" },
  { id: 229, airline: "IndiGo", role: "Cadet Pilot", aircraft: "CAE Cadet Programme", region: "Asia-Pacific", location: "India + CAE academies", type: "Cadet", minHours: 0, rated: false, posted: 0, verified: true,
  ...
  { id: 171, airline: "Cathay Pacific", role: "First Officer", aircraft: "A321 / A330 / A350 / B777 / B747", region: "Asia-Pacific", location: "Hong Kong (HKG)", type: "Direct Entry", minHours: 1500, rated: false, posted: 0, verified: true,
  ...
  { id: 172, airline: "Cathay Pacific", role: "Cadet Pilot", aircraft: "Cadet Programme (~80 weeks)", region: "Asia-Pacific", location: "Hong Kong (HKG)", type: "Cadet", minHours: 0, rated: false, posted: 0, verified: true,
  ...
  { id: 181, airline: "Singapore Airlines", role: "Cadet Pilot", aircraft: "Ab Initio (A320 rating)", region: "Asia-Pacific", location: "Singapore (SIN)", type: "Cadet", minHours: 0, rated: false, posted: 0, verified: true,
  ...
  { id: 191, airline: "United Airlines", role: "First Officer", aircraft: "B737 / A321 / B787 / B777", region: "Americas", location: "US bases (DEN, ORD, IAH, EWR…)", type: "Direct Entry", minHours: 1500, rated: false, posted: 0, verified: true,
  ...
  { id: 201, airline: "Ethiopian Airlines", role: "Captain", aircraft: "B777 / A350 / B767 / B737 (Expat)", region: "Africa", location: "Addis Ababa (ADD)", type: "Rated", minHours: 4000, rated: true, posted: 0, verified: true,
  ...
  { id: 202, airline: "Ethiopian Airlines", role: "First Officer", aircraft: "B737 NG (non-rated)", region: "Africa", location: "Addis Ababa (ADD)", type: "Direct Entry", minHours: 1500, rated: false, posted: 0, verified: true,
    salary: "See official listing",
  ...
  /* ---- Virgin Australia (virginaustralia.com) ---- */
  { id: 211, airline: "Virgin Australia", role: "First Officer", aircraft: "B737", region: "Asia-Pacific", location: "Australian bases", type: "Direct Entry", minHours: 500, rated: false, posted: 0, verified: true,
    salary: "See official listing",
