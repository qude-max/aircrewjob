...
const JOBS = [
  ...
  { id: 337, airline: "STARLUX Airlines", role: "First Officer", aircraft: "A320 / A330 / A350", region: "Asia-Pacific", location: "Taipei (TPE)", type: "Direct Entry", minHours: 1500, rated: false, posted: 0, added: "2026-06-16T13:42:00Z", verified: true,
    ...
    applyUrl: "https://careers.jx-starlux.com/Pilot/ExpPilot" },
  { id: 338, airline: "EVA Air", role: "First Officer", aircraft: "A321 / A330 / B777 / B787", region: "Asia-Pacific", location: "Taipei (TPE)", type: "Direct Entry", minHours: 2000, rated: false, posted: 0, added: "2026-06-16T14:00:00Z", verified: true,
    salary: "From NTD$227,000/mo (full pay) · 4-yr contract · accommodation",
    reqs: "Valid ICAO/JAA/FAA ATPL (frozen ATPL not accepted) · 2,000 h TT · 500 h commercial multi-engine multi-crew jet >20t · ICAO English 4+ · no-incident record · 5 yrs aviation employment (2 yrs with a bachelor's degree). 8 consecutive days off/month, EVA accommodation.",
    applyUrl: "https://www.evaair.com/en-sg/about-eva-air/careers/job-openings/pilots/" },
  { id: 339, airline: "Scoot", role: "Captain", aircraft: "A320", region: "Asia-Pacific", location: "Singapore (SIN)", type: "Rated", minHours: 3500, rated: true, posted: 0, added: "2026-06-16T14:02:00Z", verified: true,
    salary: "Fixed roster patterns · competitive · Singapore",
    reqs: "A320 Type-Rated Captain. Jet pilots: 3,500 h TT on >5,700 kg + 1,000 h PIC on multi-engine jet (multi-crew). CAAS/ICAO ATPL · ICAO English 4+. Fixed Roster Patterns. Singapore Assessment Centre.",
    applyUrl: "https://careers.flyscoot.com/job-detail/R0004821" },
  { id: 340, airline: "Scoot", role: "Captain", aircraft: "B787", region: "Asia-Pacific", location: "Singapore (SIN)", type: "Rated", minHours: 5000, rated: true, posted: 0, added: "2026-06-16T14:04:00Z", verified: true,
    salary: "Competitive · Singapore",
    reqs: "B787 Type-Rated Captain. 5,000 h TT on >5,700 kg + 2,000 h PIC on multi-engine jet (multi-crew). CAAS/ICAO ATPL · ICAO English 4+. Singapore Assessment Centre.",
    applyUrl: "https://careers.flyscoot.com/job-detail/R0005723" },
  { id: 341, airline: "Scoot", role: "Captain", aircraft: "Embraer E190", region: "Asia-Pacific", location: "Singapore (SIN)", type: "Direct Entry", minHours: 4000, rated: false, posted: 0, added: "2026-06-16T14:06:00Z", verified: true,
    salary: "Turboprop-to-jet pathway · Singapore",
    reqs: "Direct Entry E190 Captain — for experienced Turboprop Captains moving to jets. Without jet experience: 4,000 h TT on >5,700 kg + 2,000 h PIC on multi-engine turboprop (multi-crew). CAAS/ICAO ATPL · ICAO English 4+.",
    applyUrl: "https://careers.flyscoot.com/job-detail/R0005698" },
  { id: 342, airline: "Scoot", role: "First Officer", aircraft: "A320 / B787", region: "Asia-Pacific", location: "Singapore (SIN)", type: "Direct Entry", minHours: 1500, rated: false, posted: 0, added: "2026-06-16T14:08:00Z", verified: true,
    salary: "Singapore · Scoot LCC",
    reqs: "Direct Entry First Officer. 1,500 h fixed-wing on >5,700 kg · CAAS ICAO CPL(A)/ATPL(A) (foreign ATPL needs CAAS conversion) · ICAO English 4+ · meet CAAS vaccination requirements.",
    applyUrl: "https://careers.flyscoot.com/job-detail/R0004820" },
  { id: 343, airline: "Scoot", category: "crew", role: "Cabin Crew", aircraft: "A320 / B787 cabins", region: "Asia-Pacific", location: "Singapore (SIN)", type: "Direct Entry", minHours: 0, rated: false, posted: 0, added: "2026-06-16T14:10:00Z", verified: true,
    salary: "Monthly gross + staff travel · S$4,000 sign-on (SG citizens/PRs)",
    reqs: "Cabin Crew based in Singapore — 2026 SG Assessment Centre intake. SG citizens & PRs receive a S$4,000 sign-on bonus + contract-renewal bonus. Unlimited staff travel; flies 70+ destinations. Singapore Airlines' low-cost arm.",
    applyUrl: "https://careers.flyscoot.com/job-detail/R0005045" },
  { id: 344, airline: "Scoot", category: "crew", role: "Cabin Crew", aircraft: "A320 / B787 cabins", region: "Asia-Pacific", location: "Singapore (SIN)", type: "Direct Entry", minHours: 0, rated: false, posted: 0, added: "2026-06-16T14:12:00Z", verified: true,
    salary: "Monthly gross + unlimited staff travel · Singapore-based",
    reqs: "Cabin Crew based in Singapore — recruitment event in Tokyo, July 2026. Fly 70+ destinations; competitive monthly gross salary and unlimited staff travel perks for family & friends.",
    applyUrl: "https://careers.flyscoot.com/job-detail/R0005778" },
...
const AIRLINES = [
  ...
  { name: "EVA Air",            code: "BR", domain: "evaair.com",            country: "Taiwan",       fleet: "A321, A330, B777, B787",  pilots: 1400, bases: "Taipei (TPE)",               status: "hiring", note: "✓ Verified 16 Jun 2026: First Officers (A321/A330/B777/B787) — 2,000 h TT, ICAO/JAA/FAA ATPL (frozen not accepted), 4-year contract with accommodation. Taipei-based Star Alliance carrier." },
  { name: "Scoot",              code: "TR", domain: "flyscoot.com",          country: "Singapore",    fleet: "A320neo family, B787",    pilots: 800,  bases: "Singapore (SIN)",            status: "hiring", note: "✓ Verified 16 Jun 2026: Direct-Entry A320/B787/E190 Captains & First Officers plus multiple Cabin Crew intakes (SG assessment, Tokyo recruitment, part-time scheme; S$4,000 sign-on for SG citizens/PRs). Singapore Airlines' low-cost arm." },
